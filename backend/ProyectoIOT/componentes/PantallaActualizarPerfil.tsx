...
export default function PantallaPerfil({ userId }: Props) {
    ...
    const fetchUserData = async () => {
        ...
        try {
            ...
            const response = await axios.get<User>(`http://192.168.8.7:8082/api/users/${localUserId}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.put(`http://192.168.8.7:8082/api/users/update/${localUserId}`, updateData);
