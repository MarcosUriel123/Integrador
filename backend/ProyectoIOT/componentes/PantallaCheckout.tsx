...
export default function PantallaCheckout() {
                ...
                if (email) {
                    ...
                    if (userId) {
                        try {
                            ...
                            const response = await axios.get(`http://192.168.8.5:8082/api/users/${userId}`, {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.8.5:8082/api/purchase/send-purchase-email', {
                email: userEmail,
